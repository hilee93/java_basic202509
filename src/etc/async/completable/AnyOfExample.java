...
public class AnyOfExample {
    public static void main(String[] args) {
        ...
        CompletableFuture<String> startbucks = CompletableFuture.supplyAsync(() -> {
            try {
                Thread.sleep(1000);
            } catch (InterruptedException e) {
                e.printStackTrace();
            }
            System.out.println("[스타벅스] 커피 완성! (1초)");
            return "starbucks";
        });
        ...
        CompletableFuture<String> twosome = CompletableFuture.supplyAsync(() -> {
            ...
            System.out.println("[투썸] 커피 완성! (2초)");
            return "twosome";
        });
        ...
        // anyOf: 셋 중 하나라도 끝나면 즉시 결과물 리턴
        CompletableFuture<Object> winnerFuture = CompletableFuture.anyOf(startbucks, twosome, compose);

        // 결과 꺼내기 (다른 스레드 기다리지 않아요!)
